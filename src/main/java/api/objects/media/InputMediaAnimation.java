...
public class InputMediaAnimation implements BotApiObject {
    @JsonProperty("type")
    private String type;
    ...
    InputMediaAnimation(String type, String media, String thumbnail, String caption, String parseMode, List<MessageEntity> captionEntities, Integer width, Integer height, Integer duration, Boolean hasSpoiler) {
        this.type = type;
        this.media = media;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof InputMediaAnimation)) return false;
        final InputMediaAnimation other = (InputMediaAnimation) o;
    ...
    public String toString() {
        return "InputMediaAnimation(type=" + this.getType() + ", media=" + this.getMedia() + ", thumbnail=" + this.getThumbnail() + ", caption=" + this.getCaption() + ", parseMode=" + this.getParseMode() + ", captionEntities=" + this.getCaptionEntities() + ", width=" + this.getWidth() + ", height=" + this.getHeight() + ", duration=" + this.getDuration() + ", hasSpoiler=" + this.getHasSpoiler() + ")";
    }
    ...
    public static class InputMediaAnimationBuilder {
        ...
        @JsonProperty("type")
        public InputMediaAnimationBuilder type(String type) {
            this.type = type;
            return this;
        }

        @JsonProperty("media")
        public InputMediaAnimationBuilder media(String media) {
            this.media = media;
            return this;
        }
        ...
        @JsonProperty("caption_entities")
        public InputMediaAnimationBuilder captionEntities(List<MessageEntity> captionEntities) {
            this.captionEntities = captionEntities;
            return this;
        }
        ...
        public InputMediaAnimation build() {
            return new InputMediaAnimation(this.type, this.media, this.thumbnail, this.caption, this.parseMode, this.captionEntities, this.width, this.height, this.duration, this.hasSpoiler);
        }

        public String toString() {
            return "InputMediaAnimation.InputMediaAnimationBuilder(type=" + this.type + ", media=" + this.media + ", thumbnail=" + this.thumbnail + ", caption=" + this.caption + ", parseMode=" + this.parseMode + ", captionEntities=" + this.captionEntities + ", width=" + this.width + ", height=" + this.height + ", duration=" + this.duration + ", hasSpoiler=" + this.hasSpoiler + ")";
        }
    }
}
