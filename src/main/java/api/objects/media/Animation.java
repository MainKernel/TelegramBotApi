...
public class Animation implements BotApiObject {
    ...
    Animation(String fileId, String fileUniqueId, Integer width, Integer height, Integer duration, PhotoSize thumbnail, String fileName, String mimeType, Integer fileSize) {
        this.fileId = fileId;
    ...
    public String toString() {
        return "Animation(fileId=" + this.getFileId() + ", fileUniqueId=" + this.getFileUniqueId() + ", width=" + this.getWidth() + ", height=" + this.getHeight() + ", duration=" + this.getDuration() + ", thumbnail=" + this.getThumbnail() + ", fileName=" + this.getFileName() + ", mimeType=" + this.getMimeType() + ", fileSize=" + this.getFileSize() + ")";
    }
    ...
    public static class AnimationBuilder {
        ...
        @JsonProperty("file_id")
        public AnimationBuilder fileId(String fileId) {
            this.fileId = fileId;
            return this;
        }

        @JsonProperty("file_unique_id")
        public AnimationBuilder fileUniqueId(String fileUniqueId) {
            this.fileUniqueId = fileUniqueId;
            return this;
        }

        @JsonProperty("width")
        public AnimationBuilder width(Integer width) {
            this.width = width;
            return this;
        }

        @JsonProperty("height")
        public AnimationBuilder height(Integer height) {
            this.height = height;
            return this;
        }

        @JsonProperty("duration")
        public AnimationBuilder duration(Integer duration) {
            this.duration = duration;
            return this;
        }

        @JsonProperty("thumbnail")
        public AnimationBuilder thumbnail(PhotoSize thumbnail) {
            this.thumbnail = thumbnail;
            return this;
        }
        ...
        @JsonProperty("mime_type")
        public AnimationBuilder mimeType(String mimeType) {
            this.mimeType = mimeType;
            return this;
        }

        @JsonProperty("file_size")
        public AnimationBuilder fileSize(Integer fileSize) {
            this.fileSize = fileSize;
            return this;
        }

        public Animation build() {
            return new Animation(this.fileId, this.fileUniqueId, this.width, this.height, this.duration, this.thumbnail, this.fileName, this.mimeType, this.fileSize);
        }
